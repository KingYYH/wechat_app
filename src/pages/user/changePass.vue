<template>
  <div class="par">
    <!-- <headerCommon :headertt="headertt" :lefticon='lefticon' :righticon='righticon' :leftUrl="leftUrl"></headerCommon> -->
    <div class="forget">
      <div class="forget-bg">
      </div>
      ...
      <div class="tab">
        ...
        <div class="section">
          <div class="input-item">
            ...
            <x-input title="" v-model="tel" class="inp" placeholder="请输入新密码"></x-input>
          </div>
           <div class="input-item">
            <span class="iconfont icon-mima pos"></span>
            <x-input title="" v-model="tel" class="inp" placeholder="请再次输入密码"></x-input>
          </div>
